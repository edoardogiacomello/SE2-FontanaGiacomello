...
\newline
The project will therefore consists to release a web application and a mobile app which are not integrated with any other existing taxi management service.
